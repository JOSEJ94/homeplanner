...
export type GetInvitationsQuery = { __typename?: 'Query', getInvitations: Array<{ __typename?: 'GroupMember', createdAt: any, role: GroupRole, status: GroupStatus, group: { __typename?: 'Group', id: string, name: string }, user: { __typename?: 'User', email: string, name?: string | null, id: string, profilePhoto?: string | null } }> };
