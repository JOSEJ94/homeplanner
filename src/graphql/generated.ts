...
export type GetGroupsQuery = { __typename?: 'Query', getGroups: Array<{ __typename?: 'Group', id: string, name: string, rooms: Array<{ __typename?: 'Room', color: string, iconName: string, iconType: IconType, id: string, name: string }>, members: Array<{ __typename?: 'GroupMember', role: GroupRole, user: { __typename?: 'User', email: string, name?: string | null, id: string, profilePhoto?: string | null } }> }> };
...
export type AddMemberMutation = { __typename?: 'Mutation', addMember: { __typename?: 'GroupMember', role: GroupRole, user: { __typename?: 'User', email: string, name?: string | null, id: string, profilePhoto?: string | null } } };

export type RoomFragment = { __typename?: 'Room', color: string, iconName: string, iconType: IconType, id: string, name: string };

export type GroupMemberFragment = { __typename?: 'GroupMember', role: GroupRole, user: { __typename?: 'User', email: string, name?: string | null, id: string, profilePhoto?: string | null } };
